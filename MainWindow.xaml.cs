    ...
    public partial class MainWindow : Window
    {
        ...
        public MainWindow()
        {
            if (!File.Exists(@".\Save.resx"))
            {
                ...
                Warzone_Title.Source = Imaging.CreateBitmapSourceFromHBitmap(IntroMedia.warzone_connect.GetHbitmap(), IntPtr.Zero, Int32Rect.Empty, BitmapSizeOptions.FromEmptyOptions());
