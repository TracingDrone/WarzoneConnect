...
namespace WarzoneConnect.Properties {
    ...
    internal class PlotConfig {
        ...
        /// <summary>
        ///   查找类似 no-reply-daily-world 的本地化字符串。
        /// </summary>
        ...
        /// <summary>
        ///   查找类似 你是不是丝毫对密码泄露不上心啊？
        ///            如果是这样，我就拿这个字典把所有网站都炸一遍，
        ///            然后简介全部写上&quot;Tracer你好菜啊&quot;如何？
        ///            
        ///            话说，你已经好几天没和我，还有Wardog的其他人发邮件了。你最近很忙吗？ 的本地化字符串。
        /// </summary>
        ...
        ///            · 虚拟现实（VR）游戏运营团队VirtuaReal发出公开信感谢她为人类所作的贡献，“有朝一日现实世 [字符串的其余部分被截断]&quot;; 的本地化字符串。
        /// </summary>
        ...
        /// <summary>
        ///   查找类似 ······已经失踪2周了，没有人找得到这个系统吗？ 的本地化字符串。
        /// </summary>
        ...
        ///            下次想深入连接更深入的内网时，直接输入目标地址就行了，中途这个工具会自动建立代理。 的本地化字符串。
        /// </summary>
