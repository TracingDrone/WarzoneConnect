        ...
        private static class ToBeContinued
        {
            ...
            private static readonly PlotObserver.ObjectiveNode Side01 = new PlotObserver.ObjectiveNode(() => { },
                ...
                email =>
                {
                    ...
                    GameController.HostList[1].GetRoot().Add(new AutoSploit.ExpFile("UnionBurst", "（暂时性的）UBurst系统通杀",
                        new DateTime(2020, 7, 30), 0, "olaolaolaolamudamudamudamuda", 1));
                    return null;
                });
